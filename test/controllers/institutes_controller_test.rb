...
class InstitutesControllerTest < ActionController::TestCase
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post :create, institute: { address: @institute.address, contact: @institute.contact, email: @institute.email, name: @institute.name }
    end
  ...
  test "should update institute" do
    patch :update, id: @institute, institute: { address: @institute.address, contact: @institute.contact, email: @institute.email, name: @institute.name }
    assert_redirected_to institute_path(assigns(:institute))
  end
